...
- [in progress · 2026-06-09 · claude] **Real legal copy** — privacy/terms/refund are DPDP-shaped placeholders; needed before taking money (Razorpay compliance + Consumer Protection E-Comm Rules 2020). Need a subscription cancellation/refund policy w/ timelines. **Owner:** `human/lawyer` (claude can draft) (P1 for paid)
